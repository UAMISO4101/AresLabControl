# -*- coding: utf-8 -*-
#
# Laboratorio Farmaceutico documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'LaboratorioFarmaceutico.tex', u'Laboratorio Farmaceutico Documentation',
     u'Ares', 'manual'),
]
